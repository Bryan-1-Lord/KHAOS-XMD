...
//Enter your 𝗞𝗛𝗔𝗢𝗦-𝙓𝙈𝘿 session id here; must start with KHAOS~

//--------------------[ BOT NAME ]----------------------//

global.botname = process.env.BOT_NAME || '𝗞𝗛𝗔𝗢𝗦-𝙓𝙈𝘿' 

//-----------------[ OWNER NUMBER ]------------------//

global.ownernumber = process.env.OWNER_NUMBER || '233538733413' 

//-----------------[ OWNER NAME ]------------------//

global.ownername = process.env.OWNER_NAME || 'KHAOS LORD' 

//------------[ STICKER PACKNAME ]-----------------//

global.packname = process.env.STICKER_PACK_NAME || "𝗞𝗛𝗔𝗢𝗦-𝙓𝙈𝘿" 
...
global.plink = process.env.PLINK || "https://youtube.com/@@LORD-BRYAN-MASTER"

//------------------[ WATERMARK ]--------------------//

global.wm = process.env.GL_WM || "> ©𝗞𝗛𝗔𝗢𝗦-𝙓𝙈𝘿"
